                ...
                <div className="glass-card" style={{ marginTop: '40px', padding: '40px', border: '1px dashed var(--border-glass)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
                        <div>
                            ...
                            <p style={{ color: '#888', fontSize: '14px', marginTop: '5px' }}>Strategic extensions and AI-driven insights to amplify your brand's reach across the TopTechDial platform ecosystem.</p>
                        </div>
