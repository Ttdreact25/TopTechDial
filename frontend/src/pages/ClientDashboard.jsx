                ...
                <div style={styles.splitRow}>
                           ...
                           {myListings.length > 0 ? myListings.map((list) => (
                             <div key={list._id} style={styles.listingItem}>
                                ...
                                <div style={{ flexGrow: 1 }}>
                                   ...
                                   <div style={{ fontSize: '12px', color: '#727171', marginTop: '4px' }}>{list.category} • {list.city}</div>
                                </div>
                    ...
                    <div style={styles.analyticsWidget}>
                        <div className="glass-card" style={styles.growthCard}>
                           ...
                           <p style={{ fontSize: '12px', color: '#8e8d8d', marginTop: '10px' }}>Based on recent organic search traffic patterns.</p>
