...
const styles = {
    ...
    toolItem: { padding: '25px 15px', background: 'rgba(250, 246, 246, 0.02)', borderRadius: '16px', textAlign: 'center', fontSize: '12px', color: '#888', display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center', border: '1px solid var(--border-glass)', transition: 'all 0.3s' }
};
